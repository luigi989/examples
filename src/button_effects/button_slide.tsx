...
const SlideEffect = () => {
    ...
    const ButtonSlide = ({textColor, borderColor} : ButtonSlideProps) => {
        return (
            <h2 className={`group relative text-deepblue uppercase cursor-pointer`}>
                <span className={`absolute top-0 left-0 w-0 ${textColor} overflow-hidden group-hover:w-full duration-1000
